### This contains a previous version of the script `run_eval.py` that was used
### for reproducing results from the Hummingbird paper. It is kept here for reference.
### It is not used for the main experiments of our paper.
